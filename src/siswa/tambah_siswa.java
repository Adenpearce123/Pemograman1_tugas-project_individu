...
public class tambah_siswa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jScrollPane8, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 516, Short.MAX_VALUE)
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
   ...
   try {
        ...
        String sql = "INSERT INTO siswa "
                + "(nama_siswa, jenis_kelamin, tgl_lahir, alamat_siswa) "
                + "VALUES (?, ?, ?, ?)";
    ...
    private void jTable7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable7MouseClicked
        // TODO add your handling code here:
         int baris = jTable7.getSelectedRow();

    idSiswa = jTable7.getValueAt(baris, 0).toString();

    jTextField1.setText(
            jTable7.getValueAt(baris, 1).toString());

    jComboBox1.setSelectedItem(
            jTable7.getValueAt(baris, 2).toString());

    try {

        String tgl =
                jTable7.getValueAt(baris, 3).toString();
    ...
    jTextArea1.setText(
            jTable7.getValueAt(baris, 4).toString());
